...
class HousePlot {
  ...
  createFrontYardPlants() {
    ...
    this.group.add(frontYardPlants);
  }

  createGardenBeds() {
    const beds = new GardenBedManager(config, this.assets).getObject();
    this.group.add(beds);
  }
